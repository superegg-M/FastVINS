...
namespace graph_optimization {
    bool Problem::calculate_dog_leg(VecX &delta_x, unsigned long iterations) {
        ...
        double current_chi2 = get_robust_chi2();
        ...
        do {    // 迭代多次
            ...
            // 计算 h_sd 和 h_gn
            calculate_steepest_descent(_delta_x_sd);
            bool is_gn_valid = calculate_gauss_newton(_delta_x_gn);
            ...
            std::cout << "iter: " << iter << " , chi2 = " << current_chi2 << " , delta = " << _delta << std::endl;
