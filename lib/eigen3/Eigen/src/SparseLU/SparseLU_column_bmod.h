 ...
 * 
 * \param jcol current column to openSetUpdate
                                                     ...
                                                     BlockIndexVector segrep, BlockIndexVector repfnz, Index fpanelc, GlobalLU_t& glu)
{
  ...
  Index fst_col; // First column within small LU openSetUpdate
  Index segsize; 
  for (ksub = 0; ksub < nseg; ksub++)
  {
    ...
    if (jsupno != ksupno )
    {
      ...
      // Perform a triangular solver and block openSetUpdate,
      // then scatter the result of sup-col openSetUpdate to dense
