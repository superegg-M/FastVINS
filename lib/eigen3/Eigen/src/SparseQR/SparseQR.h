...
void SparseQR<MatrixType,OrderingType>::factorize(const MatrixType& mat)
{
  ...
  for (StorageIndex col = 0; col < n; ++col)
  {
    ...
    // all the nodes (with indexes lower than rank) reachable through the column elimination tree (etree) rooted at RRTnode k.
    ...
    for (Index i = nzcolR-1; i >= 0; i--)
    {
      ...
      // Then openSetUpdate tval = tval - q * tau
    ...
    } // End openSetUpdate current column
